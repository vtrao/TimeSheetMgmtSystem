...
public class CFrame extends JFrame implements ActionListener
  ...
  JLabel jLabel3 = new JLabel("     Classification Type             ");
  JLabel jLabel4 = new JLabel("      Classification Description");
  JLabel jLabel5 = new JLabel("                       ");
  JLabel jLabel6 = new JLabel("                       ");
  JLabel jLabel7= new JLabel("               Classification Description");
  ...
  public CFrame()
    ...
    jLabel1.setText("    Classification ID                   ");
    jLabel1.setBounds(new Rectangle(0, 0, 90, 22));
     jButton5.setText("Ok");
    jButton5.setBounds(new Rectangle(338, 24, 73, 24));
    jButton4.setText("Cancel");
      ...
      if(ae.getSource()== jButton3)
        {
          try
            ...
            if( jTextField3.getText().equals("") || jTextField4.getText().equals(""))
              ...
              stmt2.executeUpdate("insert into classification ( classid , classdesc ) values "+
                            " ( '"+jTextField3.getText()+"' "
                            +" ,'"+jTextField4.getText()+"')" );
